package net.turevo.rpghudmanafied.main;
...
import net.turevo.rpghudmanafied.event.ClientEventHandler;
import net.turevo.rpghudmanafied.gui.hud.*;
...
public class ModRPGHud {
	...
	public static final String MODID = "rpghudmanafied";
