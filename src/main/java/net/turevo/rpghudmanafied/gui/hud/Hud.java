...
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.AIR;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.ARMOR;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.CLOCK;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.COMPASS;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.DETAILS;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.ENTITY_INSPECT;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.EXPERIENCE;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.FOOD;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.HEALTH;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.HEALTH_MOUNT;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.HOTBAR;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.JUMP_BAR;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.LEVEL;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.MISC;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.STATUS_EFFECTS;
import static net.turevo.rpghudmanafied.gui.hud.element.HudElementType.WIDGET;
