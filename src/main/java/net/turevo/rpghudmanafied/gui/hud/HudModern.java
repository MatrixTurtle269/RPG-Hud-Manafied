...
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementArmorModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementClockModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementCompassModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementDetailsModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementEntityInspectModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementExperienceModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementFoodModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementHealthModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementHealthMountModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementHotbarModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementJumpBarModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementLevelModern;
import net.turevo.rpghudmanafied.gui.hud.element.modern.HudElementWidgetModern;
