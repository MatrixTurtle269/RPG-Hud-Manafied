...
import net.turevo.rpghudmanafied.gui.hud.element.HudElementEmpty;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementClockVanilla;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementCompassVanilla;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementDetailsVanilla;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementEntityInspectVanilla;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementMiscVanilla;
import net.turevo.rpghudmanafied.gui.hud.element.vanilla.HudElementMobEffectsVanilla;
